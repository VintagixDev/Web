...
CREATE TABLE `medicaments` (
  ...
  `medicamentType` varchar(50) DEFAULT NULL,
  `medicamentNom` varchar(30) DEFAULT NULL,
...
INSERT INTO `medicaments` VALUES (1,'paracémenteux','Doliprane'),(2,'paracémenteux','Dafalgan'),(3,'Anti-inflamattoire','Spedifen'),(4,'Statines','Tahor');
